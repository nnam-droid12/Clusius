...
def test_ssh_targets_configured_true_when_both_hosts_set(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_ssh_targets_configured_false_when_only_one_host_set(
